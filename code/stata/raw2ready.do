capture log close
*log using cpsbjan2015.log, replace
capture set mem 500m

/*------------------------------------------------
  This code relies on the code provide by Jean Roth (jroth@nber.org) to open the .dat tables. 
----------------------------------------------- */


local datelist "jan17 feb17 mar17 apr17 may17 jun17 jul17 aug17 sep17 oct17 nov17 dec17 jan18 feb18 mar18 apr18 may18 jun18 jul18 aug18 sep18 oct18 nov18 dec18"
   
   
quietly foreach date of local datelist  {
   
clear all
   
/* The following line should contain the path to your output '.dat' file */

local dat_name ".....\data\raw/`date'pub.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name ".....\data\ready\cps`date'.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name ".....\code\stata\cpsbjan2015.dct"
...
/*we keep all possible months of interview: otherwise keep if hrmis == 8 | hrmis==4 | hrmis==7 | hrmis==3 */
keep if prtage > 14
keep if prtage < 66
gen id = hrhhid + hrhhid2 + string(pulineno)

keep if pemlr > 0 & pemlr < 5 /*keep only employed or unemployed */
gen emp0 = pemlr < 3 
gen emp1 = pemlr < 3
...
gen occ0 = prdtocc1
gen occ1 = prdtocc1
replace occ1=-1 if ( occ1==23 | occ1==-1 | missing(occ1)) /* army force or unknown occupation */ 
replace occ0=-1 if ( occ0==23 | occ0==-1 | missing(occ0))

*keep id hrmonth hryear4 hurespli hrlonglk hrhtype prtage pesex pemlr prdtocc1 prernhly pulineno pwlgwgt hrmis
rename puiodp1 sameemployer
keep id hrmis hrmonth hryear4 emp0 emp1 wag0 wag1 occ0 occ1 sameemployer
